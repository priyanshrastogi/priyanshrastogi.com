    ...
    <div className='section'>
      ...
      <div className='content'>
        ...
        <div className='text-center'>
          ...
          <a target='_blank' href='https://github.com/priyanshrastogi' style={iconStyle}><FontAwesomeIcon icon={faGithub} size='lg'/></a>
          <a target='_blank' href='https://instagram.com/priyanshrastogix' style={iconStyle}><FontAwesomeIcon icon={faInstagram} size='lg'/></a>
          <a target='_blank' href='https://facebook.com/priyanshrastogix' style={iconStyle}><FontAwesomeIcon icon={faFacebook} size='lg'/></a>
          <a target='_blank' href='https://medium.com/@priyanshrastogi' style={iconStyle}><FontAwesomeIcon icon={faMedium} size='lg'/></a>
        </div>
      </div>
    </div>
  )
